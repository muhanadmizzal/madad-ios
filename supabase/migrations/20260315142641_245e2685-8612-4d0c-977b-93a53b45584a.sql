...
-- Add lifecycle fields to documents table for workflow sync
...
-- Update process_approval_action to handle document sync
...
BEGIN
  ...
  VALUES (v_company_id, v_actor_id, 'workflow_instances', 'approval_' || p_action, p_instance_id,
    jsonb_build_object('action', p_action, 'from_status', v_from_status, 'to_status', v_to_status, 'step_order', v_step_order, 'request_type', v_instance.request_type));
