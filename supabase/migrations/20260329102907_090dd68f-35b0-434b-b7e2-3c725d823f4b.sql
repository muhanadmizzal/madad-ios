...
-- Fix process_approval_action: certificate reference_id points to approval_requests, NOT documents
-- Also auto-generate certificate document with content on approval
...
BEGIN
  ...
  CASE p_action
    ...
    WHEN 'reject' THEN
      ...
      END IF;
      -- Sync approval_requests for certificate/document types
      IF v_instance.request_type LIKE 'certificate%' OR v_instance.request_type IN ('document', 'general') THEN
