  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'heading-section': ['1.5rem', { lineHeight: '1.3', fontWeight: '700' }],
        'heading-sub': ['1.25rem', { lineHeight: '1.4', fontWeight: '600' }],
      ...
      colors: {
        ...
        module: {
          DEFAULT: "hsl(var(--module-color, var(--gold)))",
          light: "hsl(var(--module-color-light, 33 56% 90%))",
          dark: "hsl(var(--module-color-dark, 31 26% 40%))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
